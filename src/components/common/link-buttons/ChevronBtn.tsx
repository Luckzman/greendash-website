  ...
  if (link && link.startsWith('#') && !link.includes('/')) {
    return (
      <button
        ...
        data-aos-delay="100"
        onClick={handleClick}
        className="flex items-center lg:gap-x-vw4 gap-x-1 capitalize lg:rounded-vw10 rounded-[10px] lg:text16 mtext18 ls032 font-inter font-medium transition cursor-pointer"
      >
        {text}
