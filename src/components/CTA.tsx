  ...
  return (
    <section className="py-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Main Heading */}
        <h2 className="w-full md:w-10/12 mx-auto text-2xl sm:text-4xl lg:text-[54px] font-dm-sans font-[700] text-black mb-4 sm:mb-6 leading-tight lg:leading-[60px] px-4">
          Don&apos;t Know Where to Start?
        </h2>

        <p className="text-sm sm:text-[16px] text-[#010D3E] font-inter mt-4 sm:mt-6 mb-8 sm:mb-12 max-w-xl mx-auto px-4">
        Not sure if your company should be reporting? <br />
