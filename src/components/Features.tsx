      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <button className={`px-6 sm:px-10 py-2 rounded-lg font-semibold text-base sm:text-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 ${
              isForProfessionalsPage 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-6 sm:mb-[31px]">
            ...
            <div className="bg-[#2A2A2A] rounded-xl p-6 sm:p-8 lg:p-12">
              <div className="flex-col items-start gap-4 sm:gap-6">
                {/* Icon */}
                <div className="w-12 h-12 mb-4 sm:mb-5 bg-gray-600 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1">
                  <h3 className="text-xl sm:text-2xl lg:text-[32px] font-medium text-white mb-3 sm:mb-4 leading-tight lg:leading-[40px]">
                    Centralized, Collaborative & Automated Data Collection
                  </h3>
                  <p className="text-white font-[16px] leading-relaxed text-sm sm:text-base">
                    Streamline data collection from multiple clients with automated workflows and collaborative tools. Reduce manual work and ensure data accuracy across all your sustainability reporting projects.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2A2A2A] rounded-xl p-6 sm:p-8 lg:p-12">
              <div className="flex-col items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-[16px] leading-relaxed text-sm sm:text-base">
                    Advanced analytics and insights to help you identify trends, benchmark performance, and provide strategic recommendations to your clients. Make data-driven decisions with comprehensive ESG intelligence.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2A2A2A] rounded-xl p-6 sm:p-8 lg:p-12">
              <div className="flex-col items-start gap-4 sm:gap-6">
                {/* Icon */}
                <div className="w-12 h-12 mb-4 sm:mb-5 bg-orange-500 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-[16px] leading-relaxed text-sm sm:text-base">
                    Customize the platform with your branding, colors, and logo. Deliver a seamless experience to your clients under your own brand while leveraging our powerful sustainability reporting infrastructure.
                  </p>
                </div>
              </div>
            </div>
