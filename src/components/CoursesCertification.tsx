      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-white rounded-[10px] px-10 py-1 mb-6 border border-[rgba(34, 34, 34, 0.1)] shadow-sm">
            <span className="text-[13px] font-medium font-inter text-black">Courses & Certification</span>
          </div>
        </div>
        
        {/* Main Headline */}
        <div className="text-center mb-16">
          <h2 className="lg:w-10/12 mx-auto font-dm-sans text-4xl lg:text-[54px] font-[700] text-black mb-6 leading-[60px]">
            Go Beyond Reporting
          </h2>
          
          <p className="lg:w-10/12 mx-auto text-[22px] font-inter text-[#010D3E] max-w-3xl leading-relaxed mb-8">
        ...
        {/* Cards Container */}
        <div className={`grid gap-8 lg:max-w-5xl mx-auto ${isForProfessionalsPage ? 'lg:grid-cols-1 lg:w-[550px]' : 'lg:grid-cols-2'}`}>
